...
function grabWebCamVideo() {
  ...
  if (navigator.mediaDevices) {
    navigator.mediaDevices.getUserMedia({
      ...
      .then(gotStream)
      .catch(function (e) {
        logError('getUserMedia() error: ' + e.name);
      });
  }
}
...
function gotStream(stream) {
  ...
  video.onloadedmetadata = function () {
    photo.width = photoContextW = 640;//video.videoWidth;
    photo.height = photoContextH = 480;//video.videoHeight;
...
function receiveDataFirefoxFactory() {
  ...
  console.log('receiveDataFirefoxFactory');
...
function renderPhoto(data) {
  ...
  canvas.width = photoContextW = 640;
  canvas.height = photoContextH = 480;

  console.log('W and H ', photoContextW, photoContextH);
